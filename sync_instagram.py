...
def main():
    ...
    for idx, reel_url in enumerate(reels_urls[:target_count], start=1):
        ...
        posts_data.append({
            ...
            "caption": caption.strip() if caption else "Ofertas e novidades do Clube da Casa Gorgulho.",
    ...
    print("\n✅ Concluído! Mantidos apenas os 8 vídeos do Clube da Casa Gorgulho.")
